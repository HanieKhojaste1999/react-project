        ...
        <Container>
            <Row className="d-flex justify-content-center">
                <Row className={styles.superMarketOffer}>
                    <Col lg={6}>
                        <Row className={styles.superMarketOfferTitle}>
                            <Col lg={4} md={4} sm={4} xs={4}>
                                <img className='mx-2' src="https://www.digikala.com/statics/img/png/amazing/fresh.png" alt="" />
                            </Col>
                            <Col lg={4} md={4} sm={4} xs={4}>
                                <img  className={`${styles.superMarketOfferTypography} mx-2`} src="https://www.digikala.com/statics/img/svg/typography/fresh.svg" alt="" />
                            </Col>
                            <Col lg={4} md={4} sm={4} xs={4}>
